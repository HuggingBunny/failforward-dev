...
const BU_METRICS = {
  all: {
    ...
    owner: 'Executive Overview · All 4 Business Units (Synthetic)',
    total: '1,420',
    rogue: '31',
    authors: '18 Active',
    comp: '94.2%'
  ...
  engineering: {
    ...
    owner: 'BU Owner: Demo BU Director · Director of Platform',
    total: '840',
    rogue: '12',
    authors: '7 Active',
    comp: '92.4%'
  ...
  datascience: {
    ...
    owner: 'BU Owner: Demo AI Head · Head of AI Research',
    total: '215',
    rogue: '14',
    authors: '6 Active',
    comp: '86.5%'
  ...
  product: {
    ...
    owner: 'BU Owner: Demo Product VP · VP of Product',
    total: '195',
    rogue: '3',
    authors: '3 Active',
    comp: '97.1%'
  ...
  infrastructure: {
    ...
    owner: 'BU Owner: Demo Infra Director · Director of Enterprise Infra',
    total: '170',
    rogue: '2',
    authors: '2 Active',
    comp: '98.5%'
...
const GOV_APIS = [
  {
    ...
    owner: 'demo.user@example.corp',
    role: 'Software Eng II',
    manager: 'Demo Manager (Eng Manager)',
    buOwner: 'Demo BU Director (Director of Platform)',
    vp: 'Demo VP (VP of Engineering)',
    ...
    stepper: [
      { title: 'Direct Manager Alert', time: 'T+0h [DISPATCHED]', detail: 'Alert sent to Demo Manager. Awaiting OpenAPI schema.', state: 'done' },
      { title: 'Business Unit Owner', time: 'T+24h [IN REVIEW]', detail: 'Escalated to Demo BU Director. Reviewing zero-retention contract.', state: 'current' },
  ...
  },
  {
    ...
    owner: 'demo.ml.researcher@example.corp',
    role: 'Staff ML Researcher',
    manager: 'Demo AI Head (Head of AI)',
    buOwner: 'Demo AI Head (Head of AI)',
    vp: 'Demo VP (VP of Engineering)',
  ...
  },
  {
    ...
    bu: 'engineering',
    buName: 'Engineering & Platform',
    owner: 'demo.backend.eng@example.corp',
  ...
  },
  {
    ...
    owner: 'demo.pm@example.corp',
    role: 'Growth PM',
    manager: 'Demo Group PM (Group PM)',
    buOwner: 'Demo Product VP (VP of Product)',
    vp: 'Demo Product VP (VP of Product)',
    ...
    stepper: [
      { title: 'Direct Manager Alert', time: 'EXPIRED', detail: 'No response from Demo Group PM within 24h window.', state: 'done' },
      { title: 'Business Unit Owner', time: 'ESCALATED', detail: 'Demo Product VP rejected unvetted proxy relay.', state: 'done' },
  ...
  },
  {
    ...
    owner: 'demo.legacy-service-acct@example.corp',
    role: 'Orphaned Route',
    manager: 'Demo Infra Manager (Infra Manager)',
    buOwner: 'Demo Infra Director (Director of Infra)',
    vp: 'Demo Ops VP (VP of Operations)',
  ...
  },
  {
    ...
    bu: 'datascience',
    buName: 'Data Science & AI Labs',
    owner: 'demo.datasci@example.corp',
    role: 'Data Scientist',
    manager: 'Demo AI Head (Head of AI)',
    buOwner: 'Demo AI Head (Head of AI)',
    vp: 'Demo VP (VP of Engineering)',
    ...
    stepper: [
      { title: 'Direct Manager Alert', time: 'T+4h [PENDING]', detail: 'Notification sent to Demo AI Head to register GPU node.', state: 'current' },
  ...
  },
  {
    ...
    bu: 'product',
    buName: 'Product & Growth',
    owner: 'demo.designer@example.corp',
    ...
    stageBadgeClass: 'sev3',
    stepper: [
      { title: 'Direct Manager Alert', time: 'T+2h [DISPATCHED]', detail: 'Automated notification sent to Demo Group PM with schema diff.', state: 'current' },
  ...
  },
  {
    ...
    bu: 'datascience',
    buName: 'Data Science & AI Labs',
    owner: 'demo.scientist@example.corp',
    ...
    stageBadgeClass: 'sev2',
    stepper: [
      { title: 'Direct Manager Alert', time: 'PASSED', detail: 'Demo AI Head endorsed experimental utility.', state: 'done' },
      { title: 'Business Unit Owner', time: 'PASSED', detail: 'Budget approved under research grant pool.', state: 'done' },
      { title: 'Vice President Gate', time: 'T+36h [IN REVIEW]', detail: 'Awaiting Demo VP sign-off on data retention terms.', state: 'current' },
  ...
  },
  {
    ...
    bu: 'engineering',
    buName: 'Engineering & Platform',
    owner: 'demo.billing.eng@example.corp',
    ...
    stageBadgeClass: 'sev2',
    stepper: [
      { title: 'Direct Manager Alert', time: 'PASSED', detail: 'Demo Manager verified breaking change in PR #442.', state: 'done' },
      { title: 'Business Unit Owner', time: 'T+18h [IN REVIEW]', detail: 'Demo BU Director reviewing PCI DSS scope impact with SecOps.', state: 'current' },
  ...
  },
  {
    ...
    bu: 'engineering',
    buName: 'Engineering & Platform',
    owner: 'demo.devops@example.corp',
  ...
  },
  {
    ...
    stageBadgeClass: 'sev3',
    stepper: [
      { title: 'Direct Manager Alert', time: 'T+5h [PENDING]', detail: 'Demo Infra Manager reviewing mTLS certificate bypass configuration.', state: 'current' },
